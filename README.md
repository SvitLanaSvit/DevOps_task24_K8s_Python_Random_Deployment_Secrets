...
2) Kubernetes (kind кластер + regcred secret + перевірки + скріни): [K8S_CLUSTER_AND_SECRET.md](K8S_CLUSTER_AND_SECRET.md)
3) Kubernetes (Deployment + Service + перевірки балансування + скріни): [K8S_DEPLOYMENT_AND_SERVICE.md](K8S_DEPLOYMENT_AND_SERVICE.md)
